...
export default class BookSearch extends React.Component {
  state = {books: ["1984", "Lord of the Flies", "Coraline", "House of Leaves", "Dracula", "Frankenstein"],
  searchTerm: ""
};
  ...
  render(){
    ...
    let matchedBooks = this.state.books.filter((book) =>{
      return book.toLocaleUpperCase().includes(this.state.searchTerm.toLocaleUpperCase());
    });
